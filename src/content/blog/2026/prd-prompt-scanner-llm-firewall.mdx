---
title: "PRD: Prompt Scanner — The First Line of Defense for LLM Applications"
date: 2026-02-17
description: "A comprehensive Product Requirements Document for prompt-scanner, an open-source module that detects prompt injection, jailbreaks, and adversarial input targeting LLM-powered applications."
tags: ["ai", "security", "open-source", "product", "llm-firewall"]
featured: true
draft: true
---
